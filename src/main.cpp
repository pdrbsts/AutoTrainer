...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR pCmdLine, int nCmdShow) {
    ...
    WNDCLASSEXW wc = {
        ...
        L"AutoTrainerMainWindowClass", NULL
    };
    RegisterClassExW(&wc);
    ...
    HWND hwnd = CreateWindowW(
        wc.lpszClassName,
        L"AutoTrainer - Game Screen OCR & Memory Scanner",
        WS_OVERLAPPEDWINDOW,
        100, 100, 1080, 720,
    ...
    App app;
    app.Initialize(hwnd, g_pd3dDevice, g_pd3dDeviceContext);
    ...
    while (!done) {
        ...
        // Rendering
        ImGui::Render();
        const float clear_color_with_alpha[4] = { 0.11f, 0.12f, 0.14f, 1.00f };
